...
var SliderList = __webpack_require__(29);
var CarouselList = __webpack_require__(31);
...
var Home = function (_React$Component) {
  ...
  function Home() {
    ...
    _this.state = { currentTarget: "slide3" };
  ...
  _createClass(Home, [{
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(SliderList, { currentTarget: this.state.currentTarget }),
        React.createElement(CarouselList, { currentTarget: this.state.currentTarget, handleClickHome: this.handleClick })
      );
    }
  }]);
...
var React = __webpack_require__(0);
var Slider = __webpack_require__(30);

var SliderList = function (_React$Component) {
            _inherits(SliderList, _React$Component);

            function SliderList() {
                        _classCallCheck(this, SliderList);

                        return _possibleConstructorReturn(this, (SliderList.__proto__ || Object.getPrototypeOf(SliderList)).call(this));
            }
            ...
            _createClass(SliderList, [{
                        ...
                        value: function render() {
                                    ...
                                    var data = [{ classInfo1: "slide1", classInfo2: "title1 captionDelay2 FromTop", content1: "Lyon", content2: "vacances été", content3: "2017", content4: "Vacance au calme dans une petite maison de campagne" }, { classInfo1: "slide2", classInfo2: "title1 captionDelay6 FromLeft", content1: "Bretagne", content2: "weekend de mai", content3: "2016", content4: "Un moment de detente en famille" }, { classInfo1: "slide3", classInfo2: "title1 captionDelay1 FromBottom", content1: "Biarritz", content2: "Anniversaire Théo", content3: "2016", content4: "Surf and fun entre amis" }];
                                    ...
                                    for (var i = 0; i < data.length; i++) {
                                                ...
                                                sliders.push(React.createElement(Slider, { classInfo1: data[i].classInfo1 + ' ' + classActiveValue, classInfo2: data[i].classInfo2, content1: data[i].content1, content2: data[i].content2, content3: data[i].content3, content4: data[i].content4 }));
                                    }
...
var Slider = function (_React$Component) {
    ...
    _createClass(Slider, [{
        ...
        value: function render() {
            return React.createElement(
                "li",
                { className: this.props.classInfo1 },
                React.createElement(
                    "div",
                    { className: "flex_caption1" },
                    React.createElement(
                        "p",
                        { className: this.props.classInfo2 },
                        this.props.content1
                    ),
                    React.createElement(
                        "p",
                        { className: "title2 captionDelay4 FromTop" },
                        this.props.content2
                    ),
                    React.createElement(
                        "p",
                        { className: "title3 captionDelay6 FromTop" },
                        this.props.content3
                    ),
                    React.createElement(
                        "p",
                        { className: "title4 captionDelay7 FromTop" },
                        this.props.content4
                    )
                )
            );
...
var CarouselList = function (_React$Component) {
  _inherits(CarouselList, _React$Component);

  function CarouselList() {
    _classCallCheck(this, CarouselList);

    var _this = _possibleConstructorReturn(this, (CarouselList.__proto__ || Object.getPrototypeOf(CarouselList)).call(this));

    _this.handleClick = _this.handleClick.bind(_this);
    return _this;
  }

  _createClass(CarouselList, [{
    key: 'handleClick',
    value: function handleClick(target) {
    ...
    value: function render() {
      ...
      var data = [{ target: "slide1", imageName: "slide1_bg" }, { target: "slide2", imageName: "slide2_bg" }, { target: "slide3", imageName: "slide3_bg" }];
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        carousels.push(React.createElement(Carousel, { handleClickCarouselList: this.handleClick, target: data[i].target, classActive: classActiveValue, imageName: data[i].imageName }));
      }
      return React.createElement(
        'div',
        { id: 'carousel' },
...
var Carousel = function (_React$Component) {
  ...
  _createClass(Carousel, [{
    ...
    value: function render() {
      return React.createElement(
        'li',
        { onClick: this.handleClick, 'data-target': this.props.target, className: this.props.classActive },
        React.createElement('img', { src: 'images/slider/' + this.props.imageName + '.jpg', alt: '' })
      );
    }
  }]);
